    ...
    <nav className="sticky top-0 z-40 bg-bg/95 backdrop-blur border-b border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => useCartStore.setState({ isOpen: true })} className="relative w-8 h-8 flex items-center justify-center border border-border hover:border-accent transition-colors" aria-label="Cart">
